...
if ( ! class_exists( 'CT_Core_Contact_Form_7_Modules_Number' ) ) :
class CT_Core_Contact_Form_7_Modules_Number {
  ...
  public function shortcode_handler( $tag ) {
    ...
    if ( in_array( $tag_obj->basetype, array( 'range', 'range*' ) ) ) {
      wp_enqueue_style( 'ctcore-bootstrap-slider' );
      wp_enqueue_script( 'ctcore-bootstrap-slider' );
    }
...
new CT_Core_Contact_Form_7_Modules_Number();
endif;
