...
if ( ! class_exists( 'CT_Core_Contact_Form_7_Modules_Text' ) ) :
class CT_Core_Contact_Form_7_Modules_Text {
  ...
  public function shortcode_handler( $tag ) {
    ...
    if ( $tag_obj->has_option( 'include_count' ) ) {
      ...
      $tag = $this->text_to_count( $tag, $count_down );
  ...
  public function text_to_count( $tag, $count_down = false ) {
    $tag['type'] = 'count';
    $tag['basetype'] = 'count';
    $tag['options'] = array();
...
new CT_Core_Contact_Form_7_Modules_Text();
endif;
